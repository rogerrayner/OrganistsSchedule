        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParameterScheduleId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedBy = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HOLY_SERVICES_PARAMETERS_SCHEDULE_ParameterScheduleId",
                        column: x => x.ParameterScheduleId,
                        principalTable: "PARAMETERS_SCHEDULE",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                table: "ORGANISTS",
                columns: new[] { "Id", "CepId", "CreatedAt", "CreatedBy", "FullName", "Level", "PhoneId", "ShortName", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { 1L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Alzenir da Silva Souza", 2, null, "Alzenir", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 2L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Jemima Oliveira Costa", 2, null, "Jemima", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 3L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Valdete Pereira Lima", 2, null, "Valdete", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 4L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Joana Martins Souza", 2, null, "Joana", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 5L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Rosemari Alves Pinto", 2, null, "Rosemari", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 6L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Camila Souza Lima", 2, null, "Camila", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 7L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Priscila Andrade Melo", 2, null, "Priscila", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 8L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Joanita Silva Costa", 2, null, "Joanita", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 9L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Vanderleia Souza Lima", 2, null, "Vanderleia", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 10L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Ana Paula Fernandes", 3, null, "Ana Paula", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 11L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Amanda Ribeiro Costa", 2, null, "Amanda", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 12L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Hallen Martins Souza", 2, null, "Hallen", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 13L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Solange Pereira Lima", 2, null, "Solange", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 14L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Dinorá Souza Pinto", 2, null, "Dinorá", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 15L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Rosangela Lima Costa", 2, null, "Rosangela", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 16L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Sarah Martins Souza", 2, null, "Sarah", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 17L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Luciana Pereira Lima", 2, null, "Luciana", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 18L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Manoela Souza Pinto", 1, null, "Manoela", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 19L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Kauany Martins Souza", 1, null, "Kauany", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L },
                    { 20L, 3L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L, "Mônica Pereira Lima", 1, null, "Mônica", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 0L }
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "HOLY_SERVICES",
                columns: new[] { "Date", "CongregationId", "OrganistId", "IsYouthMeeting" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HOLY_SERVICES_ParameterScheduleId",
                table: "HOLY_SERVICES",
                column: "ParameterScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ORGANISTS_CepId",
                table: "ORGANISTS",
                column: "CepId");
